...
class AudioCaptionDataModule:
    def __init__(self, config: dict, dataset: str):
        ...
        self.train_set = AudioCaptionDataset(audio_config, dataset, split="train")

        self.val_set = AudioCaptionDataset(audio_config, dataset, split="val")

        self.test_set = AudioCaptionDataset(audio_config, dataset, split="test")
