...
class BertCaptionModel(nn.Module):
    def __init__(self, config):
        ...
        self.model_config = AudioEncoderDecoderConfig.from_encoder_decoder_configs(
            encoder_config, decoder_config
        )
        self.model_config.decoder_start_token_id = self.tokenizer.cls_token_id
        self.model = AudioEncoderDecoderModel(
            config=self.model_config, is_pretrained=False
        )
